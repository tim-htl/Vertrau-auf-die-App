  ...
  return (
    <View style={[styles.container, { paddingTop: HEADER_HEIGHT }]}>
      ...
      <View style={styles.kopf}>
        ...
        {kurs?.ects !== undefined && (
          <Text style={styles.kursMeta}>{kurs.ects} ECTS · {kurs.semester}. Semester</Text>
        )}
      </View>
...
const styles = StyleSheet.create({
  ...
  kursName: { fontSize: 22, fontWeight: "700", color: "#1a1a1a" },
  kursMeta: { fontSize: 13, color: "#8E8E93", marginTop: 4 },
